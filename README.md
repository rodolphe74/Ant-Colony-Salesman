...
CMakeFile build system is used to create a Makefile. 
SFML graphic library uis mandatory to display the vizualisation of the algorithm.
These tools are made availables with [homebrew](https://brew.sh/) on macOS. 
